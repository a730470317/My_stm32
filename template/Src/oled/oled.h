...
#define OLED_DC_Clr()   HAL_GPIO_WritePin(GPIOG,GPIO_PIN_11,GPIO_PIN_RESET)//DC
#define OLED_DC_Set()   HAL_GPIO_WritePin(GPIOG,GPIO_PIN_11,GPIO_PIN_SET)
...
#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOG,GPIO_PIN_10,GPIO_PIN_RESET)//CLK
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOG,GPIO_PIN_10,GPIO_PIN_SET)

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOG,GPIO_PIN_12,GPIO_PIN_RESET)//DIN
#define OLED_SDIN_Set() HAL_GPIO_WritePin(GPIOG,GPIO_PIN_12,GPIO_PIN_SET)
